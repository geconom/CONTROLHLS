...
{
	float local_read[34];
	float local_write[27];
  register int counter;
  tflc_label0:for (counter=0; counter<34; counter++)
    local_read[counter]=read[counter];
	
#define y local_read[0]
#define NBai local_read[1]
#define NBbi local_read[2]
#define NSai local_read[3]
#define NSbi local_read[4]
#define PBai local_read[5]
#define PBbi local_read[6]
#define PSai local_read[7]
#define PSbi local_read[8]
#define Nai local_read[9]
#define Nbi local_read[10]
#define Zai local_read[11]
#define Zbi local_read[12]
#define Pai local_read[13]
#define Pbi local_read[14]
#define w1i local_read[15]
#define w2i local_read[16]
#define w3i local_read[17]
#define w4i local_read[18]
#define w5i local_read[19]
#define w6i local_read[20]
#define w7i local_read[21]
#define w8i local_read[22]
#define w9i local_read[23]
#define w10i local_read[24]
#define w11i local_read[25]
#define w12i local_read[26]
#define NBao &local_write[0]
#define NBbo &local_write[1]
#define NSao &local_write[2]
#define NSbo &local_write[3]
#define PBao &local_write[4]
#define PBbo &local_write[5]
#define PSao &local_write[6]
#define PSbo &local_write[7]
#define Nao &local_write[8]
#define Nbo &local_write[9]
#define Zao &local_write[10]
#define Zbo &local_write[11]
#define Pao &local_write[12]
#define Pbo &local_write[13]
#define w1o &local_write[14]
#define w2o &local_write[15]
#define w3o &local_write[16]
#define w4o &local_write[17]
#define w5o &local_write[18]
#define w6o &local_write[19]
#define w7o &local_write[20]
#define w8o &local_write[21]
#define w9o &local_write[22]
#define w10o &local_write[23]
#define w11o &local_write[24]
#define w12o &local_write[25]
#define Kin1 local_read[27]
#define Kin2 local_read[28]
#define Kout local_read[29]
#define Ka local_read[30]
#define Kb local_read[31]
#define Kw local_read[32]
#define yp local_read[33]
#define u &local_write[26]
  ...
  *w12o = (rw12) + wcoef * dw12;
  ...
  tflc_label1:for (counter=0; counter<27; counter++)
    write[counter]=local_write[counter];
